...
export class Poineer {
    static async form(ni: NetworkIdentifier) {
        ...
        const area_territory = new AreaTerritory(xuid_player, xz_chunk, dimention); //새로운 AreaTerritory클래스, 생성시 사용
        const region_territory = new RegionTerritory([area_territory], position);
